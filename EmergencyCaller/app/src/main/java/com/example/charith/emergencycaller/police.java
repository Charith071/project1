...
public class police extends AppCompatActivity {
    ...
    public void set_list_item(){
        ...
        result=databaseHelper.custom_query("select * from police");
    ...
    public void show_msg(String titile, final String msg){
        AlertDialog.Builder dialog=new AlertDialog.Builder(police.this);
    ...
    public void get_call(){
        ...
        if(ContextCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED){
            ...
            Toast.makeText(police.this,temp[2],Toast.LENGTH_LONG).show();
